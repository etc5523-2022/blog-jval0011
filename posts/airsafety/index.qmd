...
The @fig-inc shows the Airlines with the most incidents in both range of years. Surprisingly, there are 4 airlines from the US that stays in the top 10, with Delta Airlines having the same number of incidents in both period. However, looking in overall number of incidents, the numbers did decreased with the highest of 24 incidents, which has dropped almost 70%.
